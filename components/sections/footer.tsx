...
export function Footer() {
  const serviceLinks = [
    { name: "Wdrażanie Google Gemini AI", href: "/oferta/automatyzacja-ai-dla-firm" },
    { name: "Aplikacje React & Angular", href: "/oferta/dedykowane-aplikacje-react-angular" },
    { name: "Automatyzacja Operacyjna", href: "/oferta/automatyzacja-procesow-operacyjnych" },
  ]
  ...
  const socialLinks = [
    ...
    { 
      name: "GitHub", 
      href: "https://github.com/CodeWithKarol", 
      icon: (props: any) => (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="space-y-4">
                  ...
                  <li>
                    <Link href="/oferta" className="text-sm font-bold text-primary hover:underline transition-colors">
                      Pełny katalog →
                    </Link>
                  </li>
                </ul>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul role="list" className="space-y-4">
                  ...
                  <li>
                    <a href="mailto:kontakt@karol-modelski.pl" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
                      <Mail className="h-4 w-4" /> kontakt@karol-modelski.pl
                    </a>
                  </li>
                </ul>
              </div>
